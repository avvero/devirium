Время выполнения теста — это всего лишь синтетическая метрика, которой недостаточно для принятия обоснованного 
...
Контрактные интеграционные тесты — это интеграционные тесты, которые проверяют поведение приложения через публичный API, гарантируя, что взаимодействие между компонентами соблюдает контракт.
...
Интеграционные тесты проверяют взаимодействие между компонентами приложения через публичный API, часто используя моки для имитации неуправляемых внепроцессных зависимостей.
